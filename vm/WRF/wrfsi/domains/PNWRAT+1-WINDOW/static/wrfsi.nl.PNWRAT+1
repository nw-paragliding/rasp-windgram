&project_id
 SIMULATION_NAME = '"PNWRAT'
 USER_DESC = '"wxtofly@wxtofly.net'
/
&filetimespec
 START_YEAR = 2017,
 START_MONTH = 02,
...
&hgridspec
 ...
 DOMAIN_ORIGIN_LLI = 1, 28, 21
 DOMAIN_ORIGIN_LLJ = 1, 5, 14
 DOMAIN_ORIGIN_URI = 95, 91, 91
 DOMAIN_ORIGIN_URJ = 117, 111, 71
 MAP_PROJ_NAME = 'lambert'
 MOAD_KNOWN_LAT = 47
 MOAD_KNOWN_LON = -122.0
 MOAD_STAND_LATS = 47, 47
 MOAD_STAND_LONS = -122.0
 MOAD_DELTA_X = 12000.000
 MOAD_DELTA_Y = 12000.000
 SILAVWT_PARM_WRF = 0.
 TOPTWVL_PARM_WRF = 2.
/
&sfcfiles
