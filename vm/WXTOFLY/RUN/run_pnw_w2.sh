...
#Window RASP run for PNW
if ! $WXTOFLY_RUN/run_rasp.sh "PNW${N}" "$WXTOFLY_RUN/PARAMETERS/rasp.run.parameters.PNW${N}.${INIT}z.1" -q ; 
then
...
$WXTOFLY_RUN/run_background_task.sh $WXTOFLY_RUN/run_tasks_w2.sh "PNW${N}"
